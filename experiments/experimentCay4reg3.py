"""
With this script we study the 4-regular Cayley graph on the group SL(2,k) with the generating set [(1,\pm 3,0,1), (1,0,\pm 3,1)].
...
for k in range(2,35):
    ...
    if k%3!=0:
        ...
        #Construction of Cayley graph. It suffices to take the set [(1,3,0,1), (1,0,3,1)]
        G = gp.SL(2,k)
        set = [(1,3,0,1), (1,0,3,1)]
