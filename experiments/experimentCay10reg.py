"""
With this script we study the 10-regular Cayley graph on the group SL(2,k).
We use the generating set [(1,\pm 1, 0, 1), (1, 0, \pm 1, 0), (1,\pm 3,0,1), (1,0,\pm 3,1), (2,0,0,2^{-1}), (2^{-1},0,0,2)].
...
for k in range(5,35):
    #For simplicity, we only consider prime k > 4.
    if LPS.is_prime(k):

        #Construction of Cayley graph. 
        G = gp.SL(2,k)
        set = [(1,1,0,1), (1,0,1,1), (1,3,0,1), (1,0,3,1), (2,0,0,inverse(2,k))]
